...
const FRAMEWORK_VOCABULARY: Record<string, FrameworkVocabulary> = {
  ...
  GCSE_DT: {
    ...
    criteriaLabels: ["AO1", "AO2", "AO3", "AO4", "AO5"],
    criteriaNames: {
      ...
      AO4: "Demonstrate and apply knowledge and understanding",
      AO5: "Core technical principles (written exam)",
    },
  ...
  ACARA_DT: {
    ...
    criteriaLabels: ["KU", "P&P"],
    criteriaNames: {
      KU: "Knowledge and Understanding",
      "P&P": "Processes and Production Skills",
    },
  ...
  PLTW: {
    ...
    criteriaTermPlural: "performance expectations",
    criteriaTermSingular: "performance expectation",
    criteriaLabels: ["IED", "POE", "CEA", "DE"],
    criteriaNames: {
