...
export function ResolvedSummary({
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 rounded-2xl border border-emerald-500 bg-emerald-50 px-3 py-3 transition-colors hover:bg-emerald-100 group text-left"
    >
