...
import { PrinterIcon } from "./MachineCategoryIcons";
...
// PrinterIcon imported from MachineCategoryIcons.tsx (Phase 8.1d-10
// shared-icon refactor). UserIcon + ClipboardCheckIcon stay inline
// because they're only used here — no shared-icon need yet.
