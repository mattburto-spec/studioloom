...
export function RuleCard({
  ...
  return (
    <div className={`rounded-xl border p-4 ${display.tintClass}`}>
      <div className="flex items-start gap-3">
        <div aria-hidden="true" className="text-xl leading-none mt-0.5">
          {display.icon}
        </div>
        <div className="flex-1 min-w-0">
          ...
          {rule.explanation && (
            <p className="text-sm text-gray-700 mt-1">{rule.explanation}</p>
          )}
