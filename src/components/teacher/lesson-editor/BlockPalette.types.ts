...
/**
 * Class DJ block — per-instance config (13 May 2026, Phase 3).
 *
 * Stored on ActivitySection.classDjConfig when responseType === "class-dj".
 * The library row's interactive_config.tool_config in activity_blocks holds
 * the defaults; this interface is what the lesson editor lets teachers
 * tune on each instance.
 *
 * Locked algorithm constants (ENERGY_KERNEL_SIGMA, MMR_LAMBDA, EMA_ALPHA,
 * etc.) live in src/lib/class-dj/types.ts → ALGO_CONSTANTS — they are NOT
 * teacher-tunable.
 */
