...
export async function POST(request: NextRequest) {
  ...
  let teacherId: string | null = auth.teacherId;
  ...
  // Admin may override teacherId via form field (e.g. to attribute to SYSTEM_TEACHER_ID)
  const override = form.get("teacherId") as string | null;
  if (override) teacherId = override;
