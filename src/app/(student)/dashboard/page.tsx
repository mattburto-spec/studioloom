                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        {hasStudio && (
                          <Link
                            ...
                            className="mt-2 flex items-center justify-center gap-1.5 py-2 rounded-lg text-xs font-semibold bg-violet-600 text-white hover:bg-violet-700 transition-all"
                          >
