      ...
      {activeTab === "safety" && (
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-border p-6">
            ...
            <p className="text-sm text-text-secondary mb-4">
              Manage required safety certifications for this unit.
            </p>
            <Link
              href="/teacher/safety"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-border text-text-primary font-medium text-sm hover:bg-surface-alt transition"
            >
              Manage Safety Badges
            </Link>
          </div>
        </div>
      )}
