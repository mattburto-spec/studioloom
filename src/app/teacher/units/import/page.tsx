...
export default function LessonPlanConverter() {
  ...
  const loadExistingUnits = useCallback(async () => {
    ...
    try {
      ...
      // Silent fail — user can still use full unit mode
    }
    setUnitsLoaded(true);
  }, [unitsLoaded]);
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-8">
      ...
      <p className="text-sm text-text-secondary mb-6">
        Upload your existing lesson plan and we&apos;ll convert it into a StudioLoom unit.
      </p>
          ...
          >
            ...
            {uploading ? (
              <div>
                ...
                <p className="text-xs text-text-secondary mt-1">This may take a moment...</p>
              </div>
            ) : (
              <div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold text-text-primary">
                We found {editedSkeleton.lessons.length} lesson{editedSkeleton.lessons.length !== 1 ? "s" : ""} in your plan
              </h3>
