                  ...
                  <div className="flex-1 px-5 py-4">
                    ...
                    <div className="flex items-center gap-2 mt-4 flex-wrap">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-xl border-2 transition hover:bg-gray-50"
                        style={{ borderColor: c.fill, color: c.text }}
                      >
                      ...
                      <Link
                        href={`/teacher/classes/${u.classId}/progress/${u.unitId}#grading`}
                      ...
                      <Link
                        ...
                        className="text-sm font-medium px-3 py-2 rounded-xl text-text-secondary transition hover:bg-gray-100"
                      >
                        Edit
                      </Link>
                      <Link
