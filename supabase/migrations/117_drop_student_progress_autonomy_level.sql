-- Migration 117: drop student_progress.autonomy_level
--
-- Rollback of migration 116. Phase 0 of the language-scaffolding-redesign
...
-- phases.
--
-- Migration 116 was applied to local dev only — no prod data exists for
