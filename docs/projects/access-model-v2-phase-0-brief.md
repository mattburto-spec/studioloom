...
| **0.7** | Core access tables — `class_members` (with role enum `lead_teacher / co_teacher / dept_head / **mentor** / lab_tech / observer`), `audit_events`, `ai_budgets`, `ai_budget_state` | ~3 hr | 2 migration pairs (members+audit / budgets) |
