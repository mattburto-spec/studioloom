...
- **Open follow-ups:** FK hardening on `fabrication_jobs.lab_tech_picked_up_by` → `fabricators(id)` (raw UUID in v1). Anonymous RLS explicit verification. SVG fixture top-up (5 of target 10).
