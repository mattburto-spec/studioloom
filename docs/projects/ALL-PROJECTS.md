...
- **Status:** 🔴 ACTIVE — Phases 1A + 1B-1 + 1B-2 + **2A** SHIPPED to prod (20–21 Apr 2026). Checkpoint 2.1 PASSED 21 Apr. Phase 2B (SVG rules) next.
- **Priority:** P0 (high teacher pain point — DT labs' #1 reported bottleneck) | **Est remaining:** ~8–11 days | **Docs:** [fabrication-pipeline.md](fabrication-pipeline.md) (master spec) + [preflight-phase-2a-brief.md](preflight-phase-2a-brief.md) + [preflight-phase-2a-checkpoint-2-1.md](preflight-phase-2a-checkpoint-2-1.md) (last completed checkpoint) + [fabrication/phase-0-decisions.md](fabrication/phase-0-decisions.md) (D-01 through D-12 decisions log)
...
- **Phase 2A follow-ups (4 opened 21 Apr):**
  - **FU-SCANNER-OOM** (P2, resolved at discovery): 256MB Fly tier OOM'd on 29k-face seahorse during Checkpoint 2.1. Fixed by `fly scale memory 512` (~+$3/mo). Phase 2A brief §2 should be updated to document 512MB as minimum. Future machine-size profiling deferred to FU-SCANNER-RENDER work.
