...
- **School Calendar / Term System (21 Mar 2026)** — Per-teacher academic calendar for chronological unit-class tracking:
  ...
  - `src/app/teacher/units/[unitId]/class/[classId]/page.tsx` — Added term picker dropdown (fetches terms, auto-saves via PATCH).
