...
## What's next
- **NM end-to-end testing (20 Mar 2026)** — Migration 030 applied, migration 032 (page_id UUID→TEXT fix) needs applying. Full test checklist at `docs/nm-test-checklist.md`. Needs: teacher config wizard flow, student pulse submission, teacher observation from Teaching Mode, results panel data display, backward compat (units without NM render fine).
