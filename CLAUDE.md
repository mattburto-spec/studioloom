...
**Current focus (April 2026):** Dimensions3 Generation Pipeline Rebuild — **Phase A COMPLETE**, **Phase B COMPLETE**, **Phase C COMPLETE**, **Phase D COMPLETE** (9 Apr 2026, 480+ tests passing). Phase E (Admin Dashboard + Polish) next (spec: `docs/projects/dimensions3.md`). Knowledge pipeline rebuilt (ingestion active); generation pipeline + feedback system built but not yet wired to wizard routes — register at `docs/quarantine.md`.
